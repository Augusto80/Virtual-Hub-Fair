...
@Component({
  selector: 'app-perfil-registro-vendedor',
  templateUrl: './perfil-registro-vendedor.component.html',
  styleUrls: ['./perfil-registro-vendedor.component.css']
})
export class PerfilRegistroVendedorComponent implements OnInit {
  ...
  registerForm = this.formBuilder.group({
    ...
    txtNitEmpresa: ['', [ValidacionesPropias.mayor0,Validators.required, Validators.maxLength(10), Validators.minLength(7), Validators.pattern(/^[1-9]\d{6,10}$/)]],
